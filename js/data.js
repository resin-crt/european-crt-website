...
AppData.indicatorMetadata = {
  ...
  "I062": {
    ...
    "unit": "%",
    "details": "This indicator shows the percentage of total urban area in NUTS3 unit that is classified as green space (2012 data). There is robust evidence that green spaces, such as parks, trees and gardens, can help city’s resilience to the effects of climate change and extreme weather events (EEA 2016). Green spaces can have a cooling effect during periods of hot temperatures. In addition, green spaces can help to infiltrate stormwater and potentially reduce the rate of water runoff during a precipitation event so that excess water does not reach the sewarage system. Therefore, the higher the percentage of green space, the higher an area's potential adaptive capacity might be. This indicator can also be considered alongside percentage total change in green space since an existing lack of green space, combined with a decreasing trend, may signal to city planners that more should be done in terms of increasing urban greening.",
  ...
  "I075": {
    ...
    "unit": "%",
    "details": "This indicator shows the percentage change in population through migration in NUTS3 unit between 2017-2050. Areas with diverse populations have been shown to be spatially coincidental with areas of surface water flooding in certain cities where diversity was comprised of ethnic minorities, private rental and population density (Kazmierczak and Cavan 2011). There have also been a limited number of studies that have examined the interaction between linguistaclly diverse communities and increased impacts from extreme weather events (e.g. Yardley et al. 2011; Hansen et al. 2013). There is, therefore, some debate in the literature over the extent to which a population with a high number of recent migrants may indicate increased sensitivity to extreme weather events and climate change (e.g. Cutter 2003; Tapia et al. 2015). Decreases in migration, when combined with other population indicators such as age, may indicate that there is an aging population.",
